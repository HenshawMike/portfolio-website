...
export default function Contact() {
  return (
    <>
      <SEOHead
        title="Contact"
        description={`Get in touch with ${engineerInfo.name} for AI/ML consulting, collaborations, and project inquiries. ${engineerInfo.availability}`}
      />
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground font-light">
                  Fill out the form below and I'll get back to you within 24-48 hours. {engineerInfo.availability}
                </p>
              </div>
            ...
            >
              ...
              {/* Availability */}
              <div className="p-6 bg-accent rounded-sm space-y-2">
                <h3 className="text-lg font-light tracking-wide">Availability</h3>
                <p className="text-muted-foreground font-light">
